...
const configTemplate = `# Rime Dict Manager config file
...
var restartRimeCmd = "dbus-send --session --print-reply --dest=org.fcitx.Fcitx5 /controller org.fcitx.Fcitx.Controller1.SetConfig string:'fcitx://config/addon/rime' variant:string:''"
...
const ConfigPath = "$HOME/.config/rimedm/config.yaml"
